...
const ListarPEDCoordenador = () => {
    ...
    const getFormat = () => {
        if (modalidade === 'Integrado') return 'id, aluno, professor_ped, professor_disciplina, curso, disciplina, trimestre_recuperar, data_inicio, data_fim, status, situacao'
        
        if (modalidade === "ProEJA") return 'id, aluno, professor_ped, professor_disciplina, curso, disciplina, ano_semestre_reprov, data_inicio, data_fim, status, situacao'
    }
