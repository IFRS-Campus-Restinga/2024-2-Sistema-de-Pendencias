...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'dependencias_app', 'templates_pdf')  # Para templates de arquivos html -> pdf
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DRIVE_PLANO_ESTUDOS_FOLDER = os.getenv('DRIVE_PLANO_ESTUDOS_FOLDER')
DRIVE_ATIVIDADES_FOLDER = os.getenv('DRIVE_ATIVIDADES_FOLDER')
DRIVE_FORM_ENCERRAMENTO_FOLDER = os.getenv('DRIVE_FORM_ENCERRAMENTO_FOLDER')