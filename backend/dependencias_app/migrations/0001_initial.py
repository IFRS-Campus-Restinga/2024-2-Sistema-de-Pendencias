    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anoSemestreReprov', models.CharField(max_length=6)),
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='aluno_ped_proeja', to=settings.AUTH_USER_MODEL)),
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='curso_ped_proeja', to='dependencias_app.curso')),
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='disciplina_ped_proeja', to='dependencias_app.disciplina')),
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='professor_ped_proeja', to=settings.AUTH_USER_MODEL)),
                ('form_encerramento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='form_encerramento_PROEJA', to='dependencias_app.planoestudos')),
                ('plano_estudos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='plano_estudos_PROEJA', to='dependencias_app.planoestudos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacao', models.CharField(choices=[('Aprovado', 'Aprovado'), ('Reprovado', 'Reprovado'), ('Em avaliação', 'Em Avaliacao')], default='Em avaliação', max_length=255)),
                ('observacao', models.TextField(blank=True, null=True)),
                ('trimestreRec', models.CharField(choices=[('1º', 'Primeiro'), ('2º', 'Segundo'), ('3º', 'Terceiro'), ('1º, 2º', 'Primeiro Segundo'), ('1º, 3º', 'Primeiro Terceiro'), ('2º, 3º', 'Segundo Terceiro'), ('1º, 2º, 3º', 'Todos')], max_length=10)),
