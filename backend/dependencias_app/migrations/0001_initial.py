    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modalidade', models.CharField(choices=[('Integrado', 'Ensino Médio Integrado'), ('ProEJA', 'Educação de Jovens e Adultos com Ensino Profissionalizante')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ped', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dependencias_app.ped')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ano_progressao', models.CharField(max_length=4)),
                ...
                ('serie_progressao', models.CharField(choices=[('1º Ano', 'Ano 1'), ('2º Ano', 'Ano 2'), ('3º Ano', 'Ano 3'), ('4º Ano', 'Ano 4')], max_length=10)),
                ('trimestre_recuperar', models.CharField(choices=[('1º', 'Primeiro'), ('2º', 'Segundo'), ('3º', 'Terceiro'), ('1º, 2º', 'Primeiro Segundo'), ('1º, 3º', 'Primeiro Terceiro'), ('2º, 3º', 'Segundo Terceiro'), ('1º, 2º, 3º', 'Todos')], max_length=10)),
                ('ped', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dependencias_app.ped')),
            ],
            options={
                'abstract': False,
