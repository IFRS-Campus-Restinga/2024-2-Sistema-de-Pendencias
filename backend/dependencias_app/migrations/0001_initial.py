    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_calendario', models.CharField(choices=[('Integrado', 'Educação de Jovens e Adultos (EMI)'), ('ProEJA', 'Educação de Jovens e Adultos com Ensino Profissionalizante')], default='Integrado', help_text='Selecione o tipo de calendário para o evento', max_length=9, verbose_name='TipoCalendario')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Curso', to='dependencias_app.curso')),
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Professor', to=settings.AUTH_USER_MODEL)),
                ('disciplina', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Disciplina', to='dependencias_app.disciplina')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='PPT',
            fields=[
                ('dependencia_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='dependencias_app.dependencia')),
                ('turmaOrigem', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Origem', to='dependencias_app.turma')),
                ('turmaProgressao', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='Progressão', to='dependencias_app.turma')),
            ],
            options={
                'abstract': False,
            },
            bases=('dependencias_app.dependencia',),
        ),
    ]
