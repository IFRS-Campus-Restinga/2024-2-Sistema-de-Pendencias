...
from dependencias_app.views.conselhoDeClasse import *
...
urlpatterns = [
    ...
    #views para conselho de classe
    path('cadastrar-conselho-de-classe/', adicionar_conselho),
    path('listar-conselho-de-classe/', listar_conselhos),
