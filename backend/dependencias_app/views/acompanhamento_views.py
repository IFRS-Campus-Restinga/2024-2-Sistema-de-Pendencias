...
def cadastrar_acompanhamento(request, modalidade):
    try:
        ...
        return Response({'mensagem': 'Acompanhamento registrado com sucesso'}, status=status.HTTP_201_CREATED)
    except AcessoException as e:
        return Response({'mensagem': str(e)}, status=status.HTTP_403_FORBIDDEN)
