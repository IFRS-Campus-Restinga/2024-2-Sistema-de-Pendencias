...
class PPT(Progressao):
    ...
    aluno = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="ppts_aluno", verbose_name="Aluno", editable=False)
    professor_disciplina = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="ppts_disciplina_professor", verbose_name="Professor da disciplina", editable=False)
    professor_ppt = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="ppts_professor", verbose_name="Professor da progressão", editable=False)
