...
class PlanoEstudos(BaseModel):
    ...
    trimestre_recuperar = models.CharField(verbose_name="Trimestre a Recuperar", help_text="Informe o trimestre",choices=TrimestreRec.choices, max_length=20, null=False, blank=False)
