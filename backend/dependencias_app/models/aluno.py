...
class Aluno(Usuario):
    ...
    matricula = models.CharField(verbose_name="Matricula", help_text="Informe a matrícula do Aluno", max_length=10, validators=[MinLengthValidator(8)], null=False, blank=False)
